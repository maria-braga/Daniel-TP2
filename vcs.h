...
; This file defines hardware registers for the Atari 2600
...
SWACNT  = $281  ; xx00 0000   Switch A D6..D7 to Output
SWBCNT  = $283  ; xx00 0000   Switch B D6..D7 to Output
INTIM   = $284  ; xxxx xxxx   Timer output
TIM1T   = $294  ; xxxx xxxx   set 1 clock interval
TIM8T   = $295  ; xxxx xxxx   set 8 clock interval
TIM64T  = $296  ; xxxx xxxx   set 64 clock interval
T1024T  = $297  ; xxxx xxxx   set 1024 clock interval

;-------------------------------------------------------------------------------
; RIOT - Read
;-------------------------------------------------------------------------------

SWCHA   = $280  ; Port A; input or output  (read or write)
SWACNT  = $281  ; Port A DDR, 0= input, 1=output
SWCHB   = $282  ; Port B; console switches (read only)
SWBCNT  = $283  ; Port B DDR (hardwired as input)
INTIM   = $284  ; Timer output (read only)
TIMINT  = $285  ; Timer Status (read only, undocumented)
